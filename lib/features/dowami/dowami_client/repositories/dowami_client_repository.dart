...
abstract class DowamiClientRepo{
  ...
  Future<Either<Failure, Unit>> makeJobDowami({required DowamiJobModel dowamiJobModel});
}
...
class DowamiClientRepoImpel implements DowamiClientRepo {
  ...
  @override
  Future<Either<Failure, Unit>> makeJobDowami({required DowamiJobModel dowamiJobModel})async {

    try {
     await dio.postData(url:makeJobDowamiUrl, data: dowamiJobModel.toMap());
